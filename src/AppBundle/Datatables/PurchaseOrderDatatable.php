 ...
 */
class PurchaseOrderDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        $this->topActions->set(array(
            ...
            'actions' => array(
                array(
                    'route' => $this->router->generate('purchaseorder_new'),
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('purchaseorder_results'),
            'type' => 'GET'
        ));
        ...
        $this->columnBuilder
            ...
            ->add('orderState.id', 'column', array(
                'title' => 'OrderState Id',
            ))
            ->add('orderState.name', 'column', array(
    ...
    {
        return 'purchaseorder_datatable';
    }
}
