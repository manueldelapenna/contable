<?php
	 ...
	 */
	class Quanbit_Afip_Model_Enums_DocumentTypeEnum extends Quanbit_Afip_Model_Enums_AbstractEnum
	{
		 ...
		 * @var Quanbit_Afip_Model_Enums_DocumentTypeEnum
		 */
		 ...
		 *
		 * @return Quanbit_Afip_Model_Enums_DocumentTypeEnum instance
		 */
