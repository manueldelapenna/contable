<?php
	 ...
	 */
	class Quanbit_Afip_Model_Enums_TaxTypeEnum extends Quanbit_Afip_Model_Enums_AbstractEnum
	{
		 ...
		 * @var Quanbit_Afip_Model_Enums_TaxTypeEnum
		 */
		 ...
		 *
		 * @return Quanbit_Afip_Model_Enums_TaxTypeEnum instance
		 */
