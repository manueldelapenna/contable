...
class Afip_GeneralController extends Mage_Core_Controller_Front_Action
{
	...
	public function verEstadoAfipAction(){
		...
		echo "<h3>&Uacute;ltimo N&uacute;mero de RU: " . AfipInvoice::getLastNumber(TypeEnum::A) ."</h3>";
		...
		echo "<h3>&Uacute;ltimo N&uacute;mero de RU: " . AfipInvoice::getLastNumber(TypeEnum::B) ."</h3>";
